...
INSERT INTO Plane (idPlane, MaxLoad, CurrentLoad)
 VALUES('1','50','0');
INSERT INTO Plane (idPlane, MaxLoad, CurrentLoad)
 VALUES('2','50','0');
INSERT INTO Plane (idPlane, MaxLoad, CurrentLoad)
...
INSERT INTO Flight (idFlight, DateTime, Airport_Source, Airport_Destination, idPlane)
 VALUES('1','2015-11-05 14:29:36', '1', '2', '1');
INSERT INTO Flight (idFlight, DateTime, Airport_Source, Airport_Destination, idPlane)
 VALUES('2','2015-11-06 13:03:21', '3', '4', '2');
 
INSERT INTO Ticket (idTicket, idFlight, idCustomer, Price, LuggagePrice, RegistrationPriority)
